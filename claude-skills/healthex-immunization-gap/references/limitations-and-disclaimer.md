# Limitations And Disclaimer Guidance

## Core Safety Posture

This skill is for educational review and care-navigation support. It is not a
substitute for individualized clinical judgment.

The skill should help the user understand likely immunization gaps and next
steps without presenting itself as a definitive vaccine forecaster.

## When Confidence Must Be Lowered

Lower confidence when any of the following are missing or unclear:

- complete immunization history across outside systems
- patient age or age band
- vaccine product details, dose sequence, or timing
...
If the record is incomplete or contradictory:

- say what is missing
- explain how that missing context affects the conclusion
